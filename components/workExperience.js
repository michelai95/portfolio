        ...
        <div>
            ...
            <div className="work">
                <div>
                    ...
                    <div>
                        <h5 className="details">Phoenix, AZ</h5>
                        <h5 className="details">September 2019-April 2020</h5>
                    </div>
                    <div>
                        <ul>
                ...
                <div>
                    <h1>MINDBODY</h1>
                    <h3>Small/Medium Beauty and Wellness Software Specialist</h3>
                    <div>
                        <h5 className="details">Scottsdale, AZ</h5>
                        <h5 className="details">March 2019-September 2019</h5>
                    </div>
                    <div>
                        <ul>
                ...
                <div>
                    ...
                    <div>
                        <h5 className="details">Scottsdale, AZ</h5>
                        <h5 className="details">June 2018-February 2019</h5>
                    </div>
                    <div>
                        <ul>
                ...
                <div>
                    ...
                    <div>
                        <h5 className="details">Scottsdale, AZ</h5>
                        <h5 className="details">June 2017-May 2018</h5>
                    </div>
                    <div>
                        <ul>
