...
export default function BrandStatement() {
    return (
        <div>
            <p className={styles.brandStatement}>I’m a junior full stack developer who’s passionate about helping clients bring their visions to life.<br />
                ...
                I’m excellent at meeting deadlines, love collaborating with a team, as well as building projects.
            </p>
        </div>
    )
}